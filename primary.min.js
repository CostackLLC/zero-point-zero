...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (isMobile && isMobileDevice()) {
        ...
        var scriptsToPrevent = [
            'https://cdn.jsdelivr.net/gh/costackllc/zero-point-zero@v0.0.101/secondary_script.js'
        ];
...
if (isTouchDevice) {
    window.addEventListener('load', () => {
        ...
        function throttleScrollTouch(func, limit) {
            let ticking = false;
            return function() {
                if (!ticking) {
        ...
        window.addEventListener('scroll', throttleScrollTouch(handleTopbarScroll, 250));
...
// topbar separator + shadow & body on scroll | non-touch devices
    ...
    window.addEventListener('load', () => {
        ...
        function throttleScrollNonTouch(func, limit) {
            let ticking = false;
            return function() {
                if (!ticking) {
                    window.requestAnimationFrame(() => {
        ...
        window.addEventListener('scroll', throttleScrollNonTouch(handleTopbarScroll, 250));
...
function throttleResizeLink(func, limit) {
    let inThrottle;
    return function () {
        const args = arguments;
        const context = this;
...
window.addEventListener("resize", throttleResizeLink(function() {
